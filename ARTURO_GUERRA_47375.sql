...
-- ////////. DESAFIO TABLA 1 - ELIMINAR REGISTROS

-- DATOS A INSERTAR PARA POSTERIORMENTE BORRARLOS CON LA TRANSACCION
SELECT * FROM PLAYLISTS;
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`)
VALUES('Prueba Transacciones',6,16, now()),
('Prueba Transacciones',6,4, now()),
('Prueba Transacciones',6,14, now()),
('Prueba Transacciones',3,15, now()),
('Prueba Transacciones',3,3, now()),
('Prueba Transacciones',3,1, now()),
('Prueba Transacciones',9,12, now()),
('Prueba Transacciones',9,7, now());


START TRANSACTION;

DELETE FROM PLAYLISTS WHERE NAME='Prueba Transacciones';

-- ROLLBACK;
-- COMMIT;


-- ////////. DESAFIO TABLA 2 - INSERTAR REGISTROS CON SAVEPOINT

START TRANSACTION;

INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,16, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,14, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,13, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,12, now());
SAVEPOINT SP1;
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,15, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,1, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,6, now());
INSERT INTO PLAYLISTS (`name`,`user_ID`,`song_ID`,`creation_date`) VALUES('Prueba Transacciones',6,4, now());
SAVEPOINT SP2;
